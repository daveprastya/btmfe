export default function Footer() {
  return (
    <div className="container text-white bg-blue-300 flex flex-col">
      <div className="py-7">
        <div className="flex flex-row justify-center text-xl pb-7">
          <p className="mr-1 font-bold">Beauty That Moves</p>
          <p>
            {" "}
            is a movement Lorem Ipsum is simply dummy text of the printing.
          </p>
        </div>
        <div className="flex flex-row justify-center text-base">
          <p className="mr-1">Visit our website at</p>
          <a className="underline" href="http://www.wardahbeauty.com">
            www.wardahbeauty.com
          </a>
        </div>
      </div>
      <div className="flex flex-row border-t-1 border-opacity-5 mx-28 py-8 text-blue-300 place-content-center space-x-4">
